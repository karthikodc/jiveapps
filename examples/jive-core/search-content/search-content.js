       ...
       console.log("searching response is " + JSON.stringify(response));
        if (response.error) {
            ...
            $.each(rows, function(index, row) {
               ...
               html += "<table>";
               html += "<tr >";
               html += "<td>Author:</td> <td><img src=" + row.author.avatarSmallURL + " width='15px' height='15px' border='0'/></td><td><a href=https://apps.onprem.jivesoftware.com/people/"+row.author.username+">" + row.author.name + "</td>";
